...
opts = hihca_setup('runPhase', 'test', ...
                   ...
                   'dataset', 'cubcrop', ... % cubcrop, cub, aircraft, cars
                   'datasetDir', '../datasets/CUB_200_2011/CUB_200_2011',... % CUB_200_2011/CUB_200_2011; fgvc-aircraft-2013b; cars
                   ...
                   'imageScale', 2, ...
                   ...
                   'numEpochs', 40, ...
                   'batchSize', 16, ...
                   'learningRate', [0.001*ones(1,10), 0.0001*ones(1,30)], ...
                   'weightDecay', 0.0005, ...
                   'momentum', 0.9);
